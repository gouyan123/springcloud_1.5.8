 ...
 */
@EnableMongoRepositories(basePackages = {"com.dongnaoedu.springcloud.service.mongodb.dao1"},mongoTemplateRef = "mongoTemplate1")
...
public class MongoConfig1 {
    ...
    @Primary/**多数据源情况下，若使用@Autowired按照类型注入，未使用@Qualifier指定bean的名称，则默认注入@Primary注释的 bean*/
    @RefreshScope
